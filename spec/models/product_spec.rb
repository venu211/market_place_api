...
describe Product do
  ...
  context "when a title 'TV' pattern is sent" do
...
context "when a title of videogame and a min price of 100 are set" do
...
context "when title TV and min price 50 and max price 150 are set" do
